...
| `ROBOLECTRIC` | 24 | JVM test against Robolectric's Android framework, often across several API levels. |
...
**48 of 112** tools are covered by an automated test; the remaining 64 are manual-QA-only with a recorded reason.
